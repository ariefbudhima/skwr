...
<link rel="stylesheet" href="{{ asset('themes/plugins/iCheck/all.css') }}">
@endsection
...
<script type="text/javascript" src="{{ asset('themes/js/icons.js') }}"></script>
<script type="text/javascript" src="{{ asset('themes/plugins/autonumeric/autoNumeric.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('themes/plugins/iCheck/icheck.min.js') }}"></script>
@endsection
...
$(function() {
    ...
    $('#btn-submit').click(function() {
        ...
        if(isValid) {
            ...
            form.attr('action', '{{ isset($data) ? url('menus/update') : url('menus/save') }}');
            form.submit();
        } else {
